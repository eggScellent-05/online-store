      ...
      <div className="bg-neutral-100 px-5">
        ...
        <div className="flex flex-wrap justify-center gap-20">
          ...
          <div className="flex max-w-[470px] min-w-[470px] flex-1 flex-col gap-5">
            ...
            <h2 className="text-2xl font-semibold text-green-500/100">
              ${product.price}
            </h2>
            ...
            <div className="flex flex-wrap gap-5">
              ...
              <div className="bg- flex w-full items-center justify-center gap-10 rounded-full bg-green-950/95 px-5 py-3 text-2xl font-medium text-neutral-100">
                <p>Add to cart</p>
              </div>
            </div>
